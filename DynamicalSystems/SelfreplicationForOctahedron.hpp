...
#ifndef SELFREPLICATINGCOLLOIDALCLUSTERSINTEGRATION_SELFREPLICATIONFOROCTAHEDRON_HPP
#define SELFREPLICATINGCOLLOIDALCLUSTERSINTEGRATION_SELFREPLICATIONFOROCTAHEDRON_HPP
...
class SelfreplicationForOctahedron
{
 public:

  explicit SelfreplicationForOctahedron(PeriodicBoundaryConditions &pbc_config,
                                        int number_of_all_particles,
                                        Real colloid_diameter);
  ~SelfreplicationForOctahedron();
  ...
  void AddNoise(const std::vector<Sphere> &system_state, std::vector<Sphere> &derivative);
...
#endif //SELFREPLICATINGCOLLOIDALCLUSTERSINTEGRATION_SELFREPLICATIONFOROCTAHEDRON_HPP
